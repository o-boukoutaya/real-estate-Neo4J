...
class Neo4jVectorManager:
    def __init__(self, *, url: str, username: str, password: str, database: str | None = None,
    ...
    def check_index_exists(self) -> bool:
        ...
        try:
            ...
            logger.error("Check index failed: %s", e)
            return False
    ...
    def save(self, *, texts: List[str], embeddings: List[List[float]], version: str | None = None,
        ...
        try:
            ...
            logger.error("Saving vectors failed: %s", e)
            raise
    ...
    def search_similar(self, embedding: List[float], k: int = 5):
        ...
        try:
            ...
            logger.error("Search similar failed: %s", e)
            return []
